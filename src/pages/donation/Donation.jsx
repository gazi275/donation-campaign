                ...
                items?.map(i => {
                    return (<div >
                        <div className="card card-side bg-base-100 shadow-xl">
                            <figure><img className='w-full h-[250px]' src={i.image} alt="Movie" /></figure>
                                ...
                                <div style={{ backgroundColor: `${i.color1}` }} className="card-body ">
                                    ...
                                    <p style={{ color: `${i.color}` }} className='text-lg font-medium'> Price : {i.price}</p>
                                ...
                                <div className="card-actions ">
                                    <button style={{backgroundColor:`${i.color}`,color:'white'}} className='btn' >View Details</button>
                                </div>
                                </div>
